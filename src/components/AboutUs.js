...
<div>
      ...
      <div className="content">
        <div className="about">
          ...
          <div className="about_container">
            ...
            <div className="about_text">
              ...
              it's about creating lasting impressions and shaping communities.
              We're more than just a team; we're a family united by our passion
              for craftsmanship and dedication to excellence. With every
              project, we embark on a journey to transform spaces, enrich lives,
              and build legacies. From residential developments to commercial
              ventures, we bring dreams to life, one brick at a time. Our
              commitment to quality, innovation, and client satisfaction drives
              us forward, ensuring that each endeavor is met with success.
              Together, let's build not just structures, but futures filled with
        ...
        <div className="about">
          ...
          <div className="about_whyUs_container">
